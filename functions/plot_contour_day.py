...
def plot_contour_day(matrix,final_unit,numdates=None,date = None,loc = None,ps = HRRR_PS, hour=0, scaling = 1,figsize = [15,8],log=True, invert=True,ylabel='Pressure Level in hPa'):
    """
        constructs a contour plot of a variable over some other variable (usually height/pressurelevel) over 24 hours, numdates is the number of columns in the matrix (hours supplied), ps is the vertical dimension, 
        Note:  this function is not designed to work with matricies with missing
        values in the non-time dimension
    """
